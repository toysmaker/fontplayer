...
const getBend = (start, end) => {
  ...
  const bendDegree = glyph.getParam('弯曲度') + 10 * glyph.getParam('弯曲程度')
...
const getComponents = (skeleton) => {
  ...
  const start_p2_p3_vector = FP.turnAngleFromStart(start, in_tiao_curves[0].start, startTopAngle, 100)
  ...
  const start_p2_radius_before =  FP.getPointOnLine(start_p2, start_p1, FP.distance(start_p2, start_p1) * 0.5)
  const start_p2_radius_after = FP.getPointOnLine(start_p2, start_p3, FP.distance(start_p2, start_p3) * 0.4)
  const start_p3_radius_before = FP.getPointOnLine(start_p3, start_p2, FP.distance(start_p3, start_p2) * 0.4)
  const start_p3_radius_after = FP.getPointOnLine(start_p3, start_p4, FP.distance(start_p3, start_p4) * 0.5)
