...
const getComponents = (skeleton) => {
  ...
  const start_length = Math.min(35, FP.distance(pie_start, pie_end) * 0.3)
  ...
  const start_p2_p4_vector = FP.turnAngleFromStart(pie_start, out_pie_curves[0].start, startTopAngle, 100)
  const { corner: start_p2 } = FP.getIntersection(
    { type: 'line', start: start_p1, end: start_p1_p2_vector },
    { type: 'line', start: pie_start, end: start_p2_p4_vector }
  )
  ...
  // const turn_p1_radius_after = FP.getPointOnLine(turn_p1, turn_p3, FP.distance(turn_p1, turn_p3) * 0.4)
  // const turn_p2_radius_before = FP.getPointOnLine(turn_p2, turn_p1, FP.distance(turn_p2, turn_p1) * 0.4)
  // const turn_p2_radius_after = FP.getPointOnLine(turn_p2, turn_p3, FP.distance(turn_p1, turn_p0) * 0.5)
