...
import { mapCanvasX, mapCanvasY, getEllipsePoints, formatPoints, genEllipseContour, translate, computeCoords, fontRenderStyle, getStrokeWidth, selectedFile } from './adapters'
