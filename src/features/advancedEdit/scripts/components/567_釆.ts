      ...
      if (part.name === '釆') {
        ...
        // 撇
        {
          ...
          if (parameters['衔接位置'] < 0) {
            newEndX += parameters['衔接位置'] * (newEndX - parentBounds.x)
            newStartX += parameters['衔接位置'] * (newEndX - parentBounds.x)
          }
          if (parameters['衔接位置'] > 0) {
            newEndX += parameters['衔接位置'] * (parentBounds.x + parentBounds.width - (newEndX - newStartX) - newStartX)
            newStartX += parameters['衔接位置'] * (parentBounds.x + parentBounds.width - (newEndX - newStartX) - newStartX)
          }
          ...
          if (parameters['对比度'] > 0) {
            newStartX += parameters['对比度'] * (parentBounds.x + parentBounds.width - newStartX)
          }
