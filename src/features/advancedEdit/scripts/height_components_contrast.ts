...
const transformPoint = (
  ...
  let rootHeight = transformSequence[0].type === 'horizontal' ? 1000 - delta * 2 : 1000
  let rootY = transformSequence[0].type === 'horizontal' ? 0 + delta : 0
...
const updateHeightComponentsContrast = (originCharacters, characters, parameters) => {
...
export { updateHeightComponentsContrast }