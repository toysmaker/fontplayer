...
const instanceBasicGlyph_heng_zhe = (plainGlyph: ICustomGlyph, glyphInstance?: CustomGlyph) => {
...
const updateParamsByJoints = (_params, glyph) => {
  const { heng_horizontalSpan, heng_verticalSpan, zhe_horizontalSpan, zhe_verticalSpan } = _params
