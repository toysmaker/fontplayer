...
const instanceBasicGlyph_heng_zhe_zhe_wan_gou = (plainGlyph: ICustomGlyph, glyphInstance?: CustomGlyph) => {
...
const updateParamsByJoints = (_params, glyph) => {
  const { heng_horizontalSpan, heng_verticalSpan, zhe1_horizontalSpan, zhe1_verticalSpan, zhe2_horizontalSpan, zhe2_verticalSpan, wan_horizontalSpan, wan_verticalSpan, gou_horizontalSpan, gou_verticalSpan } = _params
