...
const instanceBasicGlyph_heng_zhe_tiao = (plainGlyph: ICustomGlyph, glyphInstance?: CustomGlyph) => {
...
const updateParamsByJoints = (_params, glyph) => {
  const { heng_horizontalSpan, heng_verticalSpan, zhe_horizontalSpan, zhe_verticalSpan, tiao_horizontalSpan, tiao_verticalSpan } = _params
