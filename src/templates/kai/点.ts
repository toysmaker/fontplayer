...
const instanceBasicGlyph_dian = (plainGlyph: ICustomGlyph, glyphInstance?: CustomGlyph) => {
...
const updateGlyphByParams = (params, glyph) => {
  const { horizontalSpan, verticalSpan, bendCursor, bendDegree, skeletonRefPos, weight } = params
