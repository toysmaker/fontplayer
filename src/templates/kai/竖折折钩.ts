...
const instanceBasicGlyph_shu_zhe_zhe_gou = (plainGlyph: ICustomGlyph, glyphInstance?: CustomGlyph) => {
...
const updateParamsByJoints = (_params, glyph) => {
  const { shu_horizontalSpan, shu_verticalSpan, zhe1_horizontalSpan, zhe1_verticalSpan, zhe2_horizontalSpan, zhe2_verticalSpan, gou_horizontalSpan, gou_verticalSpan } = _params
