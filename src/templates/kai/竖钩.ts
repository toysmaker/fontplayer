...
const instanceBasicGlyph_shu_gou = (plainGlyph: ICustomGlyph, glyphInstance?: CustomGlyph) => {
...
const updateParamsByJoints = (_params, glyph) => {
  const { shu_horizontalSpan, shu_verticalSpan, gou_horizontalSpan, gou_verticalSpan } = _params
